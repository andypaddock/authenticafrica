...
<section
    class="section-seasons-block <?php if($bgColor == true): echo 'alt-bg'; endif; ?><?php if (is_tax('season')):echo 'alt-bg'; endif;?> <?php the_sub_field('margin_size'); ?> <?php if($noMobile == true): echo 'no-mob'; endif; ?>"
